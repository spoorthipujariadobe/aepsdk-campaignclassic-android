...
final class CampaignClassicTestConstants {
	...
	static final class EventDataKeys {
		...
		static final class Configuration {
			...
			static final String CAMPAIGNCLASSIC_MARKETING_SERVER = "campaignclassic.marketingServer";
			static final String CAMPAIGNCLASSIC_TRACKING_SERVER = "campaignclassic.trackingServer";
			static final String CAMPAIGNCLASSIC_APP_INTEGRATION_KEY = "campaignclassic.android.integrationKey";
