...
public class CampaignClassicMapSerializerTests {
    ...
    public void serializeMap_happy() {
        ...
        // verify
        Assert.assertEquals(
                "<additionalParameters><param name=\"serial\" value=\"12345\"/><param"
                    + " name=\"double\" value=\"6.75\"/><param name=\"byte\" value=\"100\"/><param"
                    + " name=\"char\" value=\"97\"/><param name=\"short\" value=\"200\"/><param"
                    + " name=\"company\" value=\"xxx.corp\"/><param name=\"isRegistered\""
                    + " value=\"true\"/><param name=\"float\" value=\"3.14\"/><param name=\"long\""
                    + " value=\"500\"/></additionalParameters>",
                result);
    }
    ...
    public void serializeMap_Object() {
        ...
        Assert.assertTrue(
                result.matches(
                        "<additionalParameters><param name=\"object\""
                                + " value=\"java.lang.Object@(.*)\"/></additionalParameters>"));
    }
    ...
    public void serializeMap_when_SymbolsToEscapeInMap() {
        ...
        // verify
        Assert.assertEquals(
                "<additionalParameters><param name=\"greeting\""
                        + " value=\"&#39;h&gt;e&amp;l&quot;l&lt;o&#39;\"/></additionalParameters>",
                result);
    }
    ...
    public void serializeMap_when_EmptyKeyValueInMap() {
        ...
        // verify
        Assert.assertEquals(
                "<additionalParameters><param name=\"\" value=\"\"/></additionalParameters>",
                result);
    }
}
