...
/**
 * This class validates then stores the {@link Map<String, String>} message data contained in the provided {@link RemoteMessage}.
 */
public class AEPPushPayload {
     ...
     * @throws IllegalArgumentException if the message, message data, message id, or delivery id is null
     */
